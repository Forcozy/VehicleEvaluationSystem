...
function goBack() {
  // 使用router.push进行路由跳转
  router.push({ path: '/home/EvaluationRankingTablePage' });
}
...
function mounted() {
  if (route.params.id!=null){
    ...
    console.log('接收到的参数ID:', name.value);
  }
}
...
const GetPagingDataAndTotal = () => {
  ...
  axios.post("/api/QueryAllDirvernameData", {
    name: name.value,
    ...
    console.log("axios.post(/api/QueryAllDirvernameData,{},{  ==>")
    /*    console.log(res)*/
...
const GetQueryAllEvaluationDataForToday = () => {
  ...
  axios.post("/api/QueryTodayDirvernameData", {
    name: name.value,
    pageSize: pageSize.value,
    pageNum: pageNum.value
  }, {
    ...
    console.log("axios.post(/api/QueryTodayDirvernameData,{},{  ==>")
    console.log(res.data.data)
    tableData.value = res.data.data.items
    Total.value = res.data.data.total
    DataFormatOptimization()
...
const QueryAllEvaluationDataForThisMonth = () => {
  ...
  axios.post("/api/QueryThisMonthDirvernameData", {
    name: name.value,
    pageSize: pageSize.value,
    pageNum: pageNum.value
  }, {
    ...
    console.log("axios.post(/api/QueryThisMonthDirvernameData,{},{  ==>")
    console.log(res.data.data)
    tableData.value = res.data.data.items
    Total.value = res.data.data.total
    DataFormatOptimization()
